...
class AccountsWidget {
   ...
   * */
  clear() {
    document.querySelectorAll('ul.accounts-panel > li.account').forEach(account => account.remove());
  }
  ...
  onSelectAccount(element) {
    this.element.querySelectorAll('.active').forEach(account => account.classList.remove('active'));
